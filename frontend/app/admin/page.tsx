  ...
  const menuItems = [
    {
      ...
      descripcion: "Ver, suspender y gestionar usuarios",
      emoji: "👥",
      href: "/admin/usuarios",
    },
    {
      titulo: "Gestión de Vendedores",
      descripcion: "Crear y administrar vendedores",
      emoji: "🏪",
      href: "/admin/vendedores",
    },
    {
      titulo: "Gestión de Productos",
      descripcion: "Ver, administrar productos y categorías",
      emoji: "📦",
    ...
    {
      titulo: "Pagos",
      descripcion: "Ver comprobantes y estado de pagos",
      emoji: "💳",
      href: "/admin/pagos",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 mt-1">
            Gestiona todos los aspectos de Lumya
          </p>
        </div>
