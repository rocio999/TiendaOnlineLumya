...
export default function PanelAdmin() {
  const stats = [
    { titulo: "Total Usuarios", valor: "24", emoji: "👥", color: "from-blue-500 to-blue-600" },
    { titulo: "Vendedores Activos", valor: "8", emoji: "🏪", color: "from-cyan-500 to-cyan-600" },
    { titulo: "Productos", valor: "142", emoji: "📦", color: "from-purple-500 to-purple-600" },
    { titulo: "Pagos Pendientes", valor: "5", emoji: "💳", color: "from-yellow-500 to-yellow-600" },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-blue-400 mt-1">Gestiona todos los aspectos de Lumya</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {menuItems.map((item) => (
            <Link key={item.titulo} href={item.href}>
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:border-blue-200 transition cursor-pointer flex items-center gap-4">
